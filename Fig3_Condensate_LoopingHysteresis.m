...
%% Condensate looping model
% This version has simulations both from start on and start off
% the version in Fig3 is the start-off case.  The longer the simulation
% runs, the closer these two converge. The hysteresis due to starting
% condition is explored in more detail in figure 5. 
...
for r=1:nR
    ...
    for t=1:tSteps 
        ...
        if rem(t,round(tSteps/tSamples))==0
            tt=tt+1;
